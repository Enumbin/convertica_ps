...
$cp_form = array(
	...
	array(
		...
		'name'         => 'button_title',
		'opts'         => array(
			'title'       => $helper_instance->__( 'Button Title', 'smile' ),
			'value'       => 'AVAIL NOW',
			'description' => $helper_instance->__( 'Enter the button title.', 'smile' ),
		),
		'panel'        => 'Form Designer',
		'section'      => 'Design',
	...
	array(
		...
		'name'         => 'form_layout',
		'opts'         => array(
			'title'      => $helper_instance->__( 'Layout', 'smile' ),
			'value'      => '',
			'options'    => array(
				$helper_instance->__( 'cp-form-layout-1', 'smile' ) => CP_BASE_URL . 'modules/assets/images/form-layout-1.png',
				$helper_instance->__( 'cp-form-layout-2', 'smile' ) => CP_BASE_URL . 'modules/assets/images/form-layout-2.png',
				$helper_instance->__( 'cp-form-layout-3', 'smile' ) => CP_BASE_URL . 'modules/assets/images/form-layout-3.png',
				$helper_instance->__( 'cp-form-layout-4', 'smile' ) => CP_BASE_URL . 'modules/assets/images/form-layout-4.png',
			),
			'width'      => '130px',
			'imagetitle' => array(
				$helper_instance->__( 'title-0', 'smile' ) => 'Vertical - 1 Column Form Layout',
				$helper_instance->__( 'title-1', 'smile' ) => 'Vertical - 2 Column Form Layout',
				$helper_instance->__( 'title-2', 'smile' ) => 'Horizontal Form Layout',
				$helper_instance->__( 'title-3', 'smile' ) => 'Only Submit Button Layout',
			),
		),
		'panel'        => 'Form Designer',
		'section'      => 'Design',
	...
	array(
		...
		'opts'         => array(
			'title'       => $helper_instance->__( 'Button Link', 'smile' ),
			'description' => $helper_instance->__( 'Provide a link to submit button. Please add http / https prefix to URL. <br/><br/> e.g. https://www.convertplug.com/plus', 'smile' ),
			'value'       => '',
		),
		'dependency'   => array(
			'name'     => 'hidden',
	...
	array(
		...
		'opts'         => array(
			'title'       => $helper_instance->__( 'Button Link Target', 'smile' ),
			'description' => $helper_instance->__( 'The button link target specifies where to open the button link.', 'smile' ),
			'value'       => '',
			'options'     => array(
				$helper_instance->__( 'Open in New Window (_blank)', 'smile' ) => '_blank',
				$helper_instance->__( 'Open in Same Window (_self)', 'smile' ) => '_self',
			),
		),
		'panel'        => 'Form Designer',
		'section'      => 'Design',
	...
	array(
		...
		'opts'         => array(
			'title'       => $helper_instance->__( 'Grid Structure', 'smile' ),
			'description' => $helper_instance->__( 'Change submit button size depends on your grid selection.', 'smile' ),
			'value'       => '',
			'options'     => array(
				$helper_instance->__( 'cp-form-grid-structure-1', 'smile' ) => CP_BASE_URL . 'modules/assets/images/grid-structure-1-2.png',
				$helper_instance->__( 'cp-form-grid-structure-2', 'smile' ) => CP_BASE_URL . 'modules/assets/images/grid-structure-1-3.png',
				$helper_instance->__( 'cp-form-grid-structure-3', 'smile' ) => CP_BASE_URL . 'modules/assets/images/grid-structure-1-4.png',
			),
			'width'       => '100%',
			'imagetitle'  => array(
				$helper_instance->__( 'title-0', 'smile' ) => '50% Submit Button Area',
				$helper_instance->__( 'title-1', 'smile' ) => '33.33% Submit Button Area',
				$helper_instance->__( 'title-2', 'smile' ) => '25% Submit Button Area',
			),
		),
		'panel'        => 'Form Designer',
		'section'      => 'Design',
	...
	array(
		...
		'opts'         => array(
			'title'       => $helper_instance->__( 'Submit & Input box connected', 'smile' ),
			'description' => $helper_instance->__( 'Enable this option to attach input field & submit button. <br/>Note - This option will work for only one input field form.', 'smile' ),
			'value'       => false,
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Form Text Alignment', 'smile' ),
			'value'        => '',
			...
			'css_preview'  => true,
			'options'      => array(
				$helper_instance->__( 'Left', 'smile' )   => 'left',
				$helper_instance->__( 'Right', 'smile' )  => 'right',
				$helper_instance->__( 'Center', 'smile' ) => 'center',
			),
		),
		'panel'        => 'Form Designer',
		'section'      => 'Design',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Text Color', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Background Color', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Border Color', 'smile' ),
	...
	array(
		...
		'name'         => 'input_shadow',
		'opts'         => array(
			'title' => $helper_instance->__( 'Input Field Shadow', 'smile' ),
			'value' => false,
			'on'    => $helper_instance->__( 'YES', 'smile' ),
			'off'   => $helper_instance->__( 'NO', 'smile' ),
		),
	...
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Shadow Color', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Border Radius', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Font Name', 'smile' ),
			'value'        => '',
			'use_in'       => 'panel',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Font Size', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Vertical Padding', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Input Box Horizontal Padding', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Label Visibility', 'smile' ),
			'value' => false,
			'on'    => $helper_instance->__( 'Enable', 'smile' ),
			'off'   => $helper_instance->__( 'Disable', 'smile' ),
		),
		'panel'        => 'Form Designer',
		'section'      => 'Design',
		'section_icon' => 'connects-icon-disc',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Label Color', 'smile' ),
			'value'        => 'rgb(153, 153, 153)',
			'css_property' => 'color',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Label Font Name', 'smile' ),
			'value'        => '',
			'use_in'       => 'panel',
			'css_property' => 'font-family',
			'css_selector' => '.cp-form-container label',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Label Font Size', 'smile' ),
			'css_selector' => '.cp-form-container label',
			'css_property' => 'font-size',
			'value'        => 15,
			'min'          => 0,
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Button Background Color', 'smile' ),
			'value'        => 'rgb(255, 153, 0)',
	...
	array(
		...
		'name'         => 'btn_no_follow',
		'opts'         => array(
			'title' => $helper_instance->__( 'Make Button Link NoFollow', 'smile' ),
			'value' => false,
			'on'    => $helper_instance->__( 'YES', 'smile' ),
			'off'   => $helper_instance->__( 'NO', 'smile' ),
		),
	...
	array(
		...
		'opts'         => array(
			'title'   => $helper_instance->__( 'Button Alignment', 'smile' ),
			'value'   => '',
			'options' => array(
				$helper_instance->__( 'Center', 'smile' ) => 'cp-submit-wrap-center',
				$helper_instance->__( 'Left', 'smile' )   => 'cp-submit-wrap-left',
				$helper_instance->__( 'Right', 'smile' )  => 'cp-submit-wrap-right',
				$helper_instance->__( 'Full', 'smile' )   => 'cp-submit-wrap-full',
			),
		),
		'dependency'   => array(
			'name'     => 'form_layout',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Button Vertical Padding', 'smile' ),
			'css_property' => 'padding-tb',
			'css_selector' => '.cp-submit',
			'value'        => 10,
			'min'          => 0,
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Button Horizontal Padding', 'smile' ),
			'css_property' => 'padding-lr',
			'css_selector' => '.cp-submit',
			'value'        => 15,
			'min'          => 0,
	...
	array(
		...
		'opts'         => array(
			'link'  => $helper_instance->__( "Note - Above settings apply to only Built-In Forms. These won't be effective with Custom Forms.", 'smile' ),
			'value' => '',
			'title' => '',
		),
		'panel'        => 'Form Designer',
...
$helper_instance->add_filter( 'cp_get_form', 'cp_get_form_init' );
												...
												<div>
													...
													switch ( $type ) {
														...
														case 'googlerecaptcha':        // Google Recaptcha.
															if ( ! wp_script_is( 'convert-plus-google-recaptcha', 'enqueued' ) ) {
																wp_register_script( 'convert-plus-google-recaptcha', 'https://www.google.com/recaptcha/api.js', array( 'jquery' ), CP_VERSION, true );

																wp_enqueue_script( 'convert-plus-google-recaptcha' );
															}
														...
														case 'checkbox':        // checkbox.
															$label = do_shortcode( html_entity_decode( stripcslashes( htmlspecialchars( $label, ENT_QUOTES, 'utf-8' ) ), ENT_QUOTES, 'utf-8' ) );
						...
						if ( isset( $a['btn_no_follow'] ) && $a['btn_no_follow'] ) {
							...
							<a href="#" rel="nofollow noopener" class = "cp_nofollow" >
								<div class="cp-submit btn-subscribe cp_responsive <?php echo esc_attr( $a['btn_style'] ); ?> <?php echo esc_attr( $submit_anamtion_class ); ?> " <?php echo wp_kses_post( $only_button_link ) . wp_kses_post( $only_button_link_target ); ?>  <?php echo esc_attr( $data_anamtion ); ?>>
									<?php echo do_shortcode( html_entity_decode( $a['button_title'], ENT_QUOTES, 'utf-8' ) ); ?>
								</div>
							</a>
							<?php } else { ?>
...
$helper_instance->add_filter( 'cp_form_css', 'cp_form_css_init' );
/**
