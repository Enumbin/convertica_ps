...
$label_arr = array(
	$helper_instance->__( 'Year', 'smile' ),
	$helper_instance->__( 'Month', 'smile' ),
	$helper_instance->__( 'Weeks', 'smile' ),
	$helper_instance->__( 'Days', 'smile' ),
	$helper_instance->__( 'Hours', 'smile' ),
	$helper_instance->__( 'Minutes', 'smile' ),
	$helper_instance->__( 'Seconds', 'smile' ),
);

$label_arr = ( implode( ',', $label_arr ) );

$compact_labels = array(
	$helper_instance->__( 'Y', 'smile' ),
	$helper_instance->__( 'M', 'smile' ),
	$helper_instance->__( 'W', 'smile' ),
	$helper_instance->__( 'D', 'smile' ),
	$helper_instance->__( 'H', 'smile' ),
	$helper_instance->__( 'Mn', 'smile' ),
	$helper_instance->__( 'S', 'smile' ),
);
...
$cp_count_down = array(
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Enable Countdown Timer', 'smile' ),
			'value' => true,
	...
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Countdown Timer', 'smile' ),
			'value' => '',
		),
		'dependency'   => array(
			'name'     => 'disable_datepicker',
	...
	array(
		...
		'opts'         => array(
			'title'   => $helper_instance->__( 'Countdown Timer Style', 'smile' ),
			'value'   => 'style_1',
			'options' => array(
				$helper_instance->__( 'Style 1', 'smile' ) => 'style_1',
				$helper_instance->__( 'Style 2', 'smile' ) => 'style_2',
			),
		),
		'dependency'   => array(
			'name'     => 'disable_datepicker',
	...
	array(
		...
		'name'         => 'counter_font',
		'opts'         => array(
			'title'  => $helper_instance->__( 'Counter Font', 'smile' ),
			'value'  => 'Raleway',
			'use_in' => 'panel',
		),
		'dependency'   => array(
	...
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Countdown Background Color', 'smile' ),
			'value' => '#1bce7c',
		),
		'dependency'   => array(
			'name'     => 'datepicker_advance_option',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Digit Color', 'smile' ),
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Digit Border Color', 'smile' ),
			'value'        => '#1bce7c',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Digit Font Size', 'smile' ),
			'value'        => 15,
			'min'          => 10,
			'max'          => 100,
			'step'         => 1,
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Counter Border Radius', 'smile' ),
			'value'        => 5,
			'min'          => 0,
			'max'          => 100,
			'step'         => 1,
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Time Unit Color', 'smile' ),
			'value'        => '#fff',
	...
	array(
		...
		'opts'         => array(
			'title'        => $helper_instance->__( 'Time Unit Font Size', 'smile' ),
			'value'        => 15,
			'min'          => 10,
			'max'          => 40,
			'step'         => 1,
	...
	array(
		...
		'name'         => 'counter_option',
		'opts'         => array(
			'title'   => $helper_instance->__( 'Select Time Units To Display In Countdown Timer', 'smile' ),
			'value'   => 'D|H|M|S',
			'options' => array(
				$helper_instance->__( 'Years', 'smile' )   => 'Y',
				$helper_instance->__( 'Months', 'smile' )  => 'O',
				$helper_instance->__( 'Weeks', 'smile' )   => 'W',
				$helper_instance->__( 'Days', 'smile' )    => 'D',
				$helper_instance->__( 'Hours', 'smile' )   => 'H',
				$helper_instance->__( 'Minutes', 'smile' ) => 'M',
				$helper_instance->__( 'Seconds', 'smile' ) => 'S',
			),
		),
		'dependency'   => array(
			'name'     => 'disable_datepicker',
	...
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Countdown Label', 'smile' ),
			'value' => $label_arr,
		),
		'dependency'   => array(
			'name'     => 'hidden',
	...
	array(
		...
		'opts'         => array(
			'title' => $helper_instance->__( 'Countdown CompactLabel', 'smile' ),
...
$helper_instance->add_filter( 'cp_get_count_down', 'cp_get_count_down_init' );
...
$helper_instance->add_filter( 'cp_count_down_css', 'cp_count_down_css_init' );
/**
