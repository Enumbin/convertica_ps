...
$helper_instance->add_action( 'admin_enqueue_scripts', 'enqueue_padding_param_scripts' );
/**
...
function enqueue_padding_param_scripts( $hook ) {
	if ( isset( $_REQUEST['cp_admin_page_nonce'] ) && wp_verify_nonce( $_REQUEST['cp_admin_page_nonce'], 'cp_admin_page' ) ) {
		...
		$helper_instance = Helper_Global::get_instance();
		$data    = $helper_instance->$helper_instance->convertica_get_option( 'convert_plug_debug' );

		if ( false !== $cp_page && isset( $_GET['style-view'] ) && 'edit' === $_GET['style-view'] ) {
			wp_enqueue_script( 'jquery' );
			wp_enqueue_script( 'jquery-ui-core' );
			wp_enqueue_script( 'convert-plus-padding-script', SMILE_FRAMEWORK_URI . '/lib/fields/padding/js/padding.js', array( 'jquery' ), CP_VERSION, false );

			wp_enqueue_style( 'jquery-ui' );
			if ( isset( $data['cp-dev-mode'] ) && '1' === $data['cp-dev-mode'] ) {
				wp_enqueue_style( 'convert-plus-padding-style', SMILE_FRAMEWORK_URI . '/lib/fields/padding/css/padding.css', array( 'jquery' ), CP_VERSION, false );
			}
		}
	}
}
