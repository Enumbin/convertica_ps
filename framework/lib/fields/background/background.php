...
function background_settings_field( $name, $settings, $value ) {
	...
	$background_repeat = array(
		$helper_instance->__( 'No Repeat', 'smile' ) => 'no-repeat',
		$helper_instance->__( 'Repeat', 'smile' )    => 'repeat',
		$helper_instance->__( 'X Repeat', 'smile' )  => 'repeat-x',
		$helper_instance->__( 'Y Repeat', 'smile' )  => 'repeat-y',
	);
	...
	$background_size = array(
		$helper_instance->__( 'Cover', 'smile' )   => 'cover',
		$helper_instance->__( 'Contain', 'smile' ) => 'contain',
		$helper_instance->__( 'Default', 'smile' ) => 'auto',
	);
	...
	// Background Repeat.
	$output .= '<strong><label for="smile_bg_repeat">' . $helper_instance->__( 'Background Repeat', 'smile' ) . '</label></strong>';
	$bg_rpt  = 'rpt';
	...
	// Background Position.
	$output .= '<strong><label for="smile_' . $input_name . '">' . $helper_instance->__( 'Background Position', 'smile' ) . '</label></strong>';
	$bg_pos  = 'pos';
	...
	// Background Size.
	$output .= '<strong><label for="smile_' . $input_name . '">' . $helper_instance->__( 'Background Size', 'smile' ) . '</label></strong>';
	$bg_size = 'size';
...
function cp_background_script( $name ) {
	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			var input = jQuery("#smile_<?php echo $helper_instance->esc_attr( $name ); ?>");
			var parent = input.closest(".smile-element-container");

			var bg_repeat = parent.find("#smile_<?php echo $helper_instance->esc_attr( $name ); ?>_rpt");
			var bg_pos = parent.find("#smile_<?php echo $helper_instance->esc_attr( $name ); ?>_pos");
			var bg_size = parent.find("#smile_<?php echo $helper_instance->esc_attr( $name ); ?>_size");
