...
$helper_instance->add_action( 'admin_enqueue_scripts', 'cp_tags_footer', 99 );
/**
...
function cp_tags_footer( $hook ) {
	...
	if ( false !== strpos( $hook, CP_PLUS_SLUG ) ) {
		...
		wp_enqueue_script( 'convert-plus-taggle', SMILE_FRAMEWORK_URI . '/lib/fields/tags/js/tag-it.js', array( 'jquery' ), CP_VERSION, true );
		wp_enqueue_script( 'convert-plus-tags', SMILE_FRAMEWORK_URI . '/lib/fields/tags/js/tags.js', array( 'convert-plus-taggle' ), CP_VERSION, true );
	}
}
