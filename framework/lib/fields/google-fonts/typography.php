...
if ( function_exists( 'smile_add_input_type' ) ) {
	$helper_instance->add_action( 'admin_enqueue_scripts', 'cp_gfonts_param_script' );
...
function cp_gfonts_param_script() {
	Context::getContext()->controller->addJS(SMILE_FRAMEWORK_URI . '/lib/fields/google-fonts/js/google-fonts-param.js');
	// wp_register_script( 'convert-plus_gfonts_param', SMILE_FRAMEWORK_URI . '/lib/fields/google-fonts/js/google-fonts-param.js', array( 'jquery' ), CP_VERSION, false );
}
