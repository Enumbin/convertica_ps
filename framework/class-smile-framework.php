...
if ( ! defined( 'SMILE_FRAMEWORK_URI' ) ) {
	define( 'SMILE_FRAMEWORK_URI', CP_PLUGIN_URL . 'framework' );
}
...
if ( ! class_exists( 'Smile_Framework' ) ) {
	...
	class Smile_Framework {
		...
		public function __construct() {
			...
			$this->load_framework_functions();
			$this->helper_instance->add_action( 'admin_head', array( $this, 'load_compatible_scripts' ) );
		}
		...
		public function load_framework_functions() {
			$cp_settings = $this->helper_instance->convertica_get_option( 'convert_plug_settings' );
