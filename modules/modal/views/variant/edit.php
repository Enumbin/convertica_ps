...
<div class="wrap">
	<h2> <?php esc_html_e( 'Edit Variant Style', 'smile' ); ?>
		<a class="add-new-h2" href="<?php echo esc_attr( esc_url( $url ) ); ?>" title="<?php esc_attr_e( 'Back to Variant Tests', 'smile' ); ?>"><?php esc_html_e( 'Back to Variant Tests', 'smile' ); ?></a>
	</h2>
			...
			<div class="smile-default-styles theme-browser rendered">
				<div class="themes">
					...
					if ( function_exists( 'smile_style_dashboard' ) ) {
						smile_style_dashboard( 'Convert_Plug_Smile_Modals', 'modal_variant_tests', 'modal' );
					}
					?>
				</div>
			</div>
